...
public class SetPanel : BasePanel {
    ...
    public override void EnterPanel()
    {
        ...
        MoveToCenter();
        //根据实际状态初始化按钮图标
        Img_Btn_EffectAudio.sprite = mUIFacade.IsEffectMusicOn() ? btnSprites[0] : btnSprites[1];
        Img_Btn_BGAudio.sprite = mUIFacade.IsBGMusicOn() ? btnSprites[2] : btnSprites[3];
    }
